package rmt.zsc.phone.app.event.homepage;
...
import rmt.zsc.phone.app.activity.ZscListActivity;

public class ZscApp extends AbstractAppModule {

    public ZscApp(Context context) {
        super(context);
    ...
    public void appModuleOnClick(AppModule aModule) throws HDException {
        ...
        if (aModule.getIsswcard() == 0 || (isRelation(IRelativeEncoding.REUSINGLOCATIONCARD)
            ...
            Intent intent = new Intent(parent, ZscListActivity.class);
