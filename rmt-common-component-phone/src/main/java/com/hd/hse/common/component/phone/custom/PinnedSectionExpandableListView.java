...
public class PinnedSectionExpandableListView extends ExpandableListView
		implements OnScrollListener, OnGroupClickListener {
	public PinnedSectionExpandableListView(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public PinnedSectionExpandableListView(Context context) {
		super(context);
		registerListener();
	}
