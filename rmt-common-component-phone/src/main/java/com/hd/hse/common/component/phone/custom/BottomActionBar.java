...
public class BottomActionBar extends FrameLayout {
	...
	private static Logger logger = LogUtils.getLogger(BottomActionBar.class);
	...
	private void init() {
		gRootView = View.inflate(getContext(), R.layout.hd_hse_common_component_bottom_bar, null);
