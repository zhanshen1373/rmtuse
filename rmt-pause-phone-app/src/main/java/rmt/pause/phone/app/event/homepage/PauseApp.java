package rmt.pause.phone.app.event.homepage;
...
import rmt.pause.phone.app.activity.WorkPauseActivity;

/**
 * Created by dbj on 2019/7/26.
 */

public class PauseApp extends AbstractAppModule {

    public PauseApp(Context context) {
        super(context);
    ...
    public void appModuleOnClick(AppModule aModule) throws HDException {
        ...
        if (aModule.getIsswcard()==0 || (isRelation(IRelativeEncoding.REUSINGLOCATIONCARD)
            ...
            Intent intent = new Intent(parent, WorkPauseActivity.class);
