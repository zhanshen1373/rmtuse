package rmt.resume.phone.app.event.homepage;
...
import rmt.resume.phone.app.activity.WorkResumeActivity;

/**
 * Created by dbj on 2019/7/26.
 */

public class ResumeApp extends AbstractAppModule {

    public ResumeApp(Context context) {
        super(context);
    ...
    public void appModuleOnClick(AppModule aModule) throws HDException {
        ...
        if (aModule.getIsswcard() == 0 || (isRelation(IRelativeEncoding.REUSINGLOCATIONCARD)
            ...
            Intent intent = new Intent(parent, WorkResumeActivity.class);
