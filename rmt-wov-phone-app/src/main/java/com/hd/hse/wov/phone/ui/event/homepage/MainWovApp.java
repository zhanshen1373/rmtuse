...
import com.hd.hse.wov.phone.ui.activity.worktask.TaskTabulationActivityOnline;
import com.hd.hse.wov.phone.ui.activity.worktask.TaskTabulationOrganizeActivity;

public class MainWovApp extends AbstractAppModule {
	public MainWovApp(Context context) {
		super(context);
	...
	public void appModuleOnClick(AppModule aModule) throws HDException {
		...
		if (aModule.getIsswcard()==0 || (isRelation(IRelativeEncoding.REUSINGLOCATIONCARD)
			...
			Intent intent = new Intent(parent, TaskTabulationOrganizeActivity.class);
			...
			mBundle.putSerializable(LocationSwCard.SER_KEY_TARGETCLASS,
					TaskTabulationOrganizeActivity.class);
