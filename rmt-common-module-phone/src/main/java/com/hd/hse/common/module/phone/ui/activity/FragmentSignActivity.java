...
public class FragmentSignActivity extends BaseFrameActivity implements IEventListener, View.OnClickListener {

//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_fragment_sign);
//    }
    ...
    private void upSign(ImgStringVo pic, long userid) {
        ...
        HttpBusiness.action(FragmentSignActivity.this, false, call, new HttpCallBack<Object>() {
            @Override
    ...
    private void getSign(long userid) {
        if (dialog == null) {
            dialog = new ProgressDialog(FragmentSignActivity.this);
            dialog.setCanceledOnTouchOutside(false);
        }
        ...
        HttpBusiness.action(FragmentSignActivity.this, false, call, new HttpCallBack<ImgStringVo>() {
            @Override
