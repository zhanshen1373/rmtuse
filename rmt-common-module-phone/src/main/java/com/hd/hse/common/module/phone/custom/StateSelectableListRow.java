 ...
 * @see 	 
 */
public class StateSelectableListRow extends SelectableZYPListRow {

	public StateSelectableListRow(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public StateSelectableListRow(Context context) {
		super(context);
