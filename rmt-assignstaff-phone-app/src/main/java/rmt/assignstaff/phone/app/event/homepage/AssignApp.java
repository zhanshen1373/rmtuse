package rmt.assignstaff.phone.app.event.homepage;
...
import rmt.assignstaff.phone.app.activity.TaskTabulationActivity;

/**
 * created by yangning on 2017/8/16 15:23.
 */

public class AssignApp extends AbstractAppModule {
    public AssignApp(Context context) {
        super(context);
