package rmt.authorize.phone.app.event.homepage;
...
import rmt.authorize.phone.app.activity.WorkAuthorizeActivity;

public class AuthorizeApp extends AbstractAppModule {
    ...
    public void appModuleOnClick(AppModule aModule) throws HDException {
        ...
        if (aModule.getIsswcard() == 0 || (isRelation(IRelativeEncoding.REUSINGLOCATIONCARD)
            ...
            Intent intent = new Intent(parent, WorkAuthorizeActivity.class);
